...
const CouponModal = (props) => {
  ...
  return (
    <div className={`w-full  mt-[12%] h-screen   ms-[-22%] absolute ${open ? 'flex' : 'hidden'}`}>
    <div className={` w-full   h-screen  rounded-xl  absolute`}></div>
      <div className='bg-white   w-[25%] h-[50%] ms-[35%]  shadow-2xl p-5'>
        <div className='  h-full p-[2%] mt-[5%]'>
         
          <h1 className='text-center text-3xl text-orange-600 font-bold'>Select Coupon</h1>

          <div>
          {
            coupon?.coupons?.map((el)=>{

           
              
return <ul class="grid w-full gap-6 md:grid-cols-3">
    <li>
